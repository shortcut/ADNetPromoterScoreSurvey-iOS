...
class NPSFeedbackQuestionView: NPSBaseView {
    ...
    override func animateIn(withDuration duration: TimeInterval, completionBlock : (() -> Void)?) {
    ...
    override func animateOut(withDuration duration: TimeInterval, completionBlock : (() -> Void)?) {
    ...
    override func handleSwipeDownGesture(gesture: UISwipeGestureRecognizer) {
